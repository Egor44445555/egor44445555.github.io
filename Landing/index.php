<!DOCTYPE html><html lang="en" data-scrapbook-source="https://escuchaclara.site/?fbclid=IwY2xjawMSeitleHRuA2FlbQIxMABicmlkETFnblJnRUZrVkE1dEZhcTdGAR4ySPGZnUpQ1G97VA8SersNd090D2j7oSgwBqSEkNw1kUN4Lws6CdJQwLPyqQ_aem_mRmzpwtRS1sAZNZ8-ZcwgQ" data-scrapbook-create="20250820095415811"><head>
<script src="1076090084111604" async=""></script><script async="" src="fbevents.js"></script><script src="jquery.min.js"></script>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <title>Audix - un medio para mejorar la audición</title>
...
<meta property="og:title" content="Audix - un medio para mejorar la audición">
...
<header class="offer_section">
    <div class="wrapper">
        <div class="top">
            <div class="logo">
                <p style="font-size:30px;">Audix</p>
            </div>
            <div class="reg "><img src="shield.png" alt="">
                <p>Producto natural elaborado con ingredientes naturales</p>
            </div>
            <div class="reg gavno"><img src="quality.png" alt="">
                <p>Restauración  <br> progresiva de la audición</p> 
            </div>
        </div>
        <h1>Recuperación al 90% de la audición perdida </h1>
        <ul class="bullites">
            <li>
                <p>
                    <b>Normaliza </b>  <br> el funcionamiento de la audición
                </p>
            </li>
            <li>
                <p><b>Mejora </b> <br>la audición <br> natural
            </p></li>
        </ul>
        <img src="product.jpg" alt="" class="product_mob">
        <div class="form_block">
            <div class="prices">
                <div class="sale">
                    DESCUENTO<br> DEL -50%
                </div>
                <div class="old">280 PEN</div>
                <div class="new">140 PEN</div>
            </div>
            <div class="form">
                <p>DEJE SUS DATOS Y LO LLAMAREMOS PARA DARLE MÁS DETALLES</p>
                <form class="main-order-form" action="lemon.php" method="post">
...
<section class="s1">
    <div class="wrapper">
        <h2><span>MÁS DEL 70%</span> DE LOS COLOMBIANOS PIERDE LA AUDICIÓN A LOS 40 AÑOS</h2>
        <p>¿A qué se debe esta tendencia tan deprimente?</p>
        <div class="list1">
            <div class="el">               
                <img src="s1_1.jpg" alt="">
                <h3>Ruido en las ciudades colombianas</h3>
                <p>El ruido del transporte público, las autopistas y la música a todo volumen en los auriculares hacen que la pérdida de audición de la mayoría de los habitantes de la ciudad empeore cada día. </p>
            </div>
            <div class="el"> 
                <img src="s1_2.jpg" alt="">
                <h3>Infecciones <br> no tratadas</h3>
                <p>Los procesos inflamatorios, a veces sin síntomas claramente perceptibles, pueden hacer que su audición se resienta. </p>
            </div>
            <div class="el"> 
                <img src="s1_3.jpg" alt="">
                <h3>Uso de <br>medicamentos</h3>
                <p>Muchos medicamentos suelen causar pérdida de audición.</p>
            </div>
            <div class="el"> 
                <img src="s1_4.jpg" alt="">
                <h3>Sistema <br>inmunológico débil</h3>
                <p>Los científicos han demostrado que una de las principales causas de las infecciones de oído es un sistema inmunitario débil.</p>
            </div>
        </div>
    </div>
</section>
<section class="s2">
    <div class="wrapper">
        <div class="table">
            <div class="col">
            <h2>¿CÓMO RECONOCER PROBLEMAS  <br> <span>CON SU AUDICIÓN? </span></h2>
                <ul>
                    <li>Experimenta pitidos, zumbidos o ruidos en los oídos</li>
                    <li>Es usted propenso a los mareos </li>
                    <li>Asimetría en la percepción del habla entre los 2 oídos</li>
                    <li>Fatiga y dolores de cabeza frecuentes</li>
                </ul>
                <p class="alert">Si no empiezas a combatirlo hoy - <br> <span>La pérdida de audición es inevitable!</span></p></div>
            <div class="col">
                <div class="img">
                    <img src="s2_img.jpg" alt="">
                </div>
            </div>
        </div>
    </div>
...
<section class="s3">
    <div class="wrapper">
        <h2>Audix - ES UN POTENTE TRATAMIENTO DE RESTAURACIÓN  <br> <span>NATURAL DE LA AUDICIÓN</span> </h2>
        <p>Gracias a sus potentes ingredientes, mejora la audición. <br> <b>Audix refuerza su audición y estimula su cuerpo para luchar contra las bacterias dañinas.</b></p>
        <ul>
            <li>Restaura los tejidos dañados a nivel celular y establece la comunicación neuronal con el cerebro</li>
            <li>Restablece la función de los huesecillos del oído medio, elimina los tapones de cera, evitando su reaparición</li>
            <li>Adecuado para el tratamiento, la limpieza y la prevención de las enfermedades del canal auditivo</li>
            <li>Fácil de usar y no provoca reacciones adversas en comparación con otros productos similares</li>
        </ul>
        <div class="form_block">
            <div class="prices">
                <div class="sale">
...
<section class="s4">
    <div class="wrapper">
        <h2>
            <span>RESULTADOS CLÍNICOS PARA </span> <br> LA AUDICIÓN CON Audix</h2>
        <p>Un <b>total de 7.458</b> personas con pérdida de audición total y parcial participaron en el estudio.</p>
        <div class="percents">
            <div class="perc">
                <div class="num">92,3%</div>
                <span>de los pacientes</span>
                <b>Audición 100% restaurada</b>
            </div>
            <div class="perc">
                <div class="num">100%</div>
                <span>de los pacientes</span>
                <b>Estaría dispuesto a recomendar Audix a sus amigos y familiares </b>
            </div>
            <div class="perc">
                <div class="num">98%</div>
                <span>de los pacientes</span>
                <b>Eliminaron síntomas dolorosos  </b>
            </div>
        </div>
        <a href="#order_form" class="button">Restablecer la salud auditiva</a>
    </div>
</section>
<section class="s6">
    <div class="wrapper">
        <div class="left">
            <h2>GENTE REAL. <br> <span>RESULTADOS REALES.</span></h2>
            <p>Cada día recibimos miles de comentarios de agradecimiento de nuestros clientes. Sus resultados son sorprendentes.  </p>
            <a href="#order_form" class="button">Pedir Audix</a>
        </div>
        <div class="right reviews owl-carousel owl-loaded owl-drag">
            
            
            
        <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-2680px, 0px, 0px); transition: 0.25s; width: 4690px;"><div class="owl-item cloned" style="width: 650px; margin-right: 20px;"><div class="rev">
                <h4>En dos meses, mi audición había mejorado hasta alcanzar un nivel cómodo. </h4>
                <p>En 2022 fui a un especialista en Bogotá y me recomendaron Audix. Un producto bueno e innovador que ayuda a mejorar mi audición gracias a varios ingredientes activos. En mi caso, mi audición ha alcanzado el 75% en 2 meses, lo que ya es una zona cómoda para mí. La mayoría de mis nuevos conocidos y colegas no conocen mi problema. ¡Recomiendo el producto!</p>
                <div class="user">
                    <div class="img"><img src="ava2.jpg" alt=""></div>
                    <b class="name">Анна, 24 años <br> Cartagena</b>
                </div>
            </div></div><div class="owl-item cloned" style="width: 650px; margin-right: 20px;"><div class="rev">
                <h4>Me alegro de haberlo detectado a tiempo y de haber empezado el tratamiento.</h4>
                <p>Nunca en mi vida hubiera creído que el divorcio pudiera causar sordera. Pero me dio la otitis media, yendo a juicio me di cuenta que no estaba escuchando bien. Gracias a los que inventaron el Audix, y a alguien que le contaba a un amigo en la calle sobre el tratamiento- tuve suerte de escuchar, o habría considerado la enfermedad como un "castigo" :( </p>
                <div class="user">
                    <div class="img"><img src="ava3.jpg" alt=""></div>
                    <b class="name">Carlos, 42 años <br> Boyaca</b>
                </div>
            </div></div><div class="owl-item" style="width: 650px; margin-right: 20px;"><div class="rev">
                <h4>Estoy muy contento con el resultado. Mi audición ha mejorado increíblemente.</h4>
                <p>Leí muchos comentarios positivos sobre Audix en varios foros, así que decidí creer en las críticas y también lo pedí. No me arrepiento de mi decisión. En un mes, recuperé la audición y desaparecieron mis dolores de cabeza. </p>
                <div class="user">
                    <div class="img"><img src="ava1.jpg" alt=""></div>
                    <b class="name">María, 35 años <br> Manizales  </b>
                </div>
            </div></div><div class="owl-item" style="width: 650px; margin-right: 20px;"><div class="rev">
                <h4>En dos meses, mi audición había mejorado hasta alcanzar un nivel cómodo. </h4>
                <p>En 2022 fui a un especialista en Bogotá y me recomendaron Audix. Un producto bueno e innovador que ayuda a mejorar mi audición gracias a varios ingredientes activos. En mi caso, mi audición ha alcanzado el 75% en 2 meses, lo que ya es una zona cómoda para mí. La mayoría de mis nuevos conocidos y colegas no conocen mi problema. ¡Recomiendo el producto!</p>
            ...
            </div></div><div class="owl-item active" style="width: 650px; margin-right: 20px;"><div class="rev">
                <h4>Me alegro de haberlo detectado a tiempo y de haber empezado el tratamiento.</h4>
                <p>Nunca en mi vida hubiera creído que el divorcio pudiera causar sordera. Pero me dio la otitis media, yendo a juicio me di cuenta que no estaba escuchando bien. Gracias a los que inventaron el Audix, y a alguien que le contaba a un amigo en la calle sobre el tratamiento- tuve suerte de escuchar, o habría considerado la enfermedad como un "castigo" :( </p>
                <div class="user">
                    <div class="img"><img src="ava3.jpg" alt=""></div>
...
<section class="s9">
    <div class="wrapper">
        <h2>PIDE Audix  <span>MUY FÁCILMENTE</span></h2>
        <div class="how_to_order">
            <ul class="list3">
                <li>
                    <b>Rellene un sencillo formulario con  <br> su nombre y número de teléfono. </b>
                    <div class="img"><img src="order1.png" alt=""></div></li>
                <li>
                    <b>Nuestro especialista se pondrá en contacto con usted  <br> para discutir todos los detalles. </b>
                    <div class="img"><img src="order2.png" alt=""></div></li>
                <li>
                    <b>Usted paga su paquete<br>  al recibirlo </b>
                    <div class="img"><img src="order3.png" alt=""></div></li>
            </ul>
        </div>
    </div>
</section>
<section class="offer_section bottom" id="order_form">
    <div class="wrapper">
        <div class="top">
            <div class="logo">
                <p style="font-size:30px;">Audix</p></div>
            <div class="reg"><img src="shield.png" alt="">
                <p>Producto natural elaborado con ingredientes naturales</p>
            </div>
            <div class="reg gavno"><img src="quality.png" alt="">
                <p>Restauración progresiva de la audición</p>
            </div>
        </div>
        <h1>Recuperación al 90% de la audición perdida</h1>
        <ul class="bullites">
...
<footer class="footer_section">
    <img src="blank.gif" alt="copyright">
    <div>    <a href="#" class="_popup-link" data-target="politics">Privacy policy</a>
        <div class="sep">|</div>
            <a href="#" class="_popup-link" data-target="agreement">User agreement</a>
</div>
</footer>
<!-- start person gift -->
<!-- <link rel='stylesheet' href='persongift.css'>
<div class="persongift" id="persongift">
    <div class="persongift__wrapper">
        <div class="persongift__close" id="persongift__close"></div>
        <div class="persongift__grid">
            <div class="persongift__left">
                <img class="persongift__img" src="persongift.png" alt="">
                <div class="persongift__text"><p>Con su pedido recibirá un regalo personalizado de IMMUSTEN - 30 cápsulas de refuerzo de la inmunidad.</p></div>
            </div>
            <div class="persongift__right">
                <div class="persongift__bullit">
                    <div class="persongift__items"><span></span> <div>Mejora el bienestar general</div></div>
                    <div class="persongift__items"><span></span> <div>Fortalece el sistema inmunológico</div></div>
                    <div class="persongift__items"><span></span> <div>Protege el organismo contra los virus</div></div>
                </div>
            </div>
        </div>       
    </div>
...
<script type="text/javascript" src="copyrights.js"></script>
...
<link href="popup-m1-style.css" rel="stylesheet" type="text/css">
<script src="popup-m1.js" type="text/javascript"></script>
...
<link rel="stylesheet" href="enhancer_all_style.css">
...
<script type="text/javascript">
    $(document).ready(function(){     
        $('#persongift__close').click(function () {
            $('#persongift').css('display', 'none');
        });
	}); 
</script>
